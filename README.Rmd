...
The three comprising factors of the ADI, the ADI-3 (i.e., the "Berg indices"), have been incorporated and are now automatically included in the output of both `get_adi()` and `calculate_adi()`.
