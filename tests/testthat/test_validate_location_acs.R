context("Test validate_location for acs")
...
test_that("validate_location() for acs - state", {
...
test_that("validate_location() for acs - county", {  
...
test_that("validate_location() for acs - tract", {  
...
test_that("validate_location() for acs - block group", {  
